...
def count_down(count):
    ...
    count_sec = count % 60
    if count_sec < 10:  # when count is less than 10, add a '0' in front of the number
...
tomato_img = PhotoImage(file="tomato.png")  # import photo image
canvas.create_image(100, 112, image=tomato_img)  # place image
timer_text = canvas.create_text(100, 130, text="00:00", fill="white", font=(FONT_NAME, 28, "bold"))
canvas.grid(column=1, row=1)

# "Timer" label
title_label = Label(text="Timer", bg=YELLOW, fg=PINK, font=(FONT_NAME, 36, "bold"))
